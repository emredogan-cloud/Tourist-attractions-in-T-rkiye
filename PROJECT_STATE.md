...
**Phase 6 — Maps, Directions & Visitor Stats** (next; map foundation already exists from Phase 2 — Phase 6 enriches with visitor stats import + map filtering + DirectionsButton coverage)
